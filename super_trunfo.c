...
int main()
{
    ...
    float densidadePopulacional; // Densidade populacional da cidade.
    float pibPerCapita; // Produto Interno Bruto per Capita da cidade.
    ...
    pibPerCapita = (float)(pib2 * 1000000000) / populacao2;
